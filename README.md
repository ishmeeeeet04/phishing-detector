...
- ✅ **AI Classification** — Logistic Regression trained on 5,500+ real emails with 98%+ accuracy
- ✅ **Rule-Based Engine** — Detects urgency language, fake sender domains, credential theft
...
**4. Add VirusTotal API key — create a .env file and add:**
...
**Output:**
    ...
    Reasons:
      ...
      - Found threats: suspended, terminated
